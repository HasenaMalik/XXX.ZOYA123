...
module.exports.run = async function ({ api, event, args, Users, permssion, getText ,Threads}) {
  ...
  const listNDH = NDH || config.NDH ||  [];
  {
    ...
    var link = [
      "https://https://i.imgur.com/vozAonW.jpeg",
    ];
...
─────────────────\n♪♪♪♪♪♪♪『${namebot}』.♪♪♪♪♪♪♪\n─────────────────\n» Prefix system: ${PREFIX}\n» Prefix box: ${prefix}\n» Modules: ${commands.size}\n» Ping: ${Date.now() - dateNow}ms\n» Total users: ${global.data.allUserID.length} \n» Total threads: ${global.data.allThreadID.length} ─────────────────\n╭───────────╮\n🌻 𝙤𝙬𝙣𝙚𝙧 ज़ोया बाबू🤸🌻\n╰───────────╯ ╭────────────╮\n🥀𝙗𝙤𝙩 𝗮𝗱𝗺𝗶𝗻 ज़ोया बाबू 🤸  💞 \n╰────────────╯\n🍇𝙛𝙖𝙘𝙚𝙗𝙤𝙤𝙠 𝙖𝙘𝙘𝙤𝙪𝙣𝙩🍇\n──────https://www.facebook.com/mian.838794?mibextid=ZbWKwL─────────────────`, attachment: fs.createReadStream(__dirname + "/cache/kensu.jpg"), }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/kensu.jpg"));
